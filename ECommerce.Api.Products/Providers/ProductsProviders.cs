...
namespace ECommerce.Api.Products.Providers
{
    public class ProductsProviders : IProductsProvider
    {
        ...
        public ProductsProviders(ProductsDbContext dbContext, ILogger<ProductsProviders> logger, IMapper mapper)
        {
        ...
        public async Task<(bool IsSuccess, IEnumerable<Models.Product> Products, string ErrorMessages)> GetProcutsAsync()
        {
            try
            {
